...
class _MonyTransferEftInvestmentConfirmationView
    ...
    switch (controller.selectedBankAccount.value!.category) {
      case BankAccountCategory.mission:
        return Column(
          children: [
            buildAdditionalRow(
              controller.selectedBankAccount.value!.category!.customText
                  .toString(),
              "${controller.selectedBankAccount.value!.title}(${controller.selectedBankAccount.value!.currency.toString()})",
            ),
            buildAdditionalRow(
              "Alınacak Tutar",
            ...
            buildAdditionalRow(
              "Dönem Sonu Getirisi",
              Formatter.formatMoney(controller.investAmount.value *
                  (1 + controller.selectedProject!.earningRate!.toInt() / 100)),
            ),
        ...
        return Column(
          children: [
            buildAdditionalRow(
              controller.selectedBankAccount.value!.category!.customText
                  .toString(),
              "${controller.selectedBankAccount.value!.title}",
            ),
            buildAdditionalRow(
              "İşlem Tarihi",
            ...
            buildAdditionalRow(
              "Alıcı Adı Soyadı",
              controller.recipientFullNameController.text,
            ),
            buildAdditionalRow(
              "Alıcı IBAN",
              controller.selectedBankAccount.value!.iban.toString(),
            ),
            buildAdditionalRow(
              "Ödeme Türü",
            ...
            buildAdditionalRow("İşlem Ücret", "0,00 ₺"),
            buildAdditionalRow("Tutar",
                Formatter.formatMoney(controller.transactionAmount.value)),
          ],
        );
