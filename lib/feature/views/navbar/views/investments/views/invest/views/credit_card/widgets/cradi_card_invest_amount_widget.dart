...
class _CradiCardInvestAmountWidget extends BaseGetView<InvestViewController> {
  @override
  ...
  Widget get _amountBox => Obx(() => Flexible(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: controller.craditAmountFillColor.value,
            borderRadius: BorderRadius.circular(12.r),
            shape: BoxShape.rectangle,
            border: Border.all(
              color: controller.craditAmountBorderColor.value,
            ),
          ),
          child: _amountInput,
        ),
  ...
  Widget get _amountInput => IntrinsicWidth(
        child: CustomTextField(
          ...
          textEditingController: controller.craditAmountTextController,
          filled: true,
          ...
          onChanged: controller.onCradiCardInvestAmountChanged,
